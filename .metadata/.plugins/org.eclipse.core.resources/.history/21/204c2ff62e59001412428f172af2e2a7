...
public class CCProgressTimer extends CCNode {
    ...
    public static CCProgressTimer progress(String filename) {
        return new CCProgressTimer(CCSpriteFrameCache.sharedSpriteFrameCache().getSpriteFrame(filename).getTexture());
    }
    public static CCProgressTimer progressWithFile(String filename) {
