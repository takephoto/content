...
public class CCMenuItemSprite extends CCMenuItem implements CCRGBAProtocol {
    ...
    public static CCMenuItemSprite itemFromNormalSprite(CCNode normalSprite, CCNode selectedSprite, CCNode target, String selector) {
        return new CCMenuItemSprite(normalSprite, selectedSprite, null, target, selector);
    }
    ...
    private boolean isSelectSamed = false;
