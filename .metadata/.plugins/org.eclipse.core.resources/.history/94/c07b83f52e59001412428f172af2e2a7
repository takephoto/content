...
public class CCMoveBy extends CCMoveTo {
    ...
    public static CCMoveBy actionWithDuration(float duration, CGPoint pos) {
        return new CCMoveBy(duration, pos);
    }
    public static CCMoveBy actionWithDuration(double duration, CGPoint pos) {
        return new CCMoveBy((float)duration, pos);
    }
