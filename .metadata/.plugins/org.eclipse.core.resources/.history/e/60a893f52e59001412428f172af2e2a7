...
public class CCMoveTo extends CCIntervalAction {
    ...
    public static CCMoveTo actionWithDuration(float t, CGPoint pos) {
        return new CCMoveTo(t, pos);
    }
    public static CCMoveTo actionWithDuration(double t, CGPoint pos) {
        return new CCMoveTo((float)t, pos);
    }
