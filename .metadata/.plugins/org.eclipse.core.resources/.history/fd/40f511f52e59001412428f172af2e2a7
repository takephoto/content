...
public class CCMenuItemImage extends CCMenuItemSprite {
    ...
    public static CCMenuItemImage itemFromNormalSprite(String value, String value2) {
        return item(value, value2, null, null, null);
    }
    public static CCMenuItemImage itemFromNormalSprite(String value, String value2, CCNode t, String s) {
