...
//	protected CCIntervalAction other;
    ...
    /** creates the action */
    public static CCSpeed action(CCAction action, float r) {
        return new CCSpeed(action, r);
    }
    public static CCSpeed actionWithAction(CCAction action, float r) {
        return new CCSpeed(action, r);
    }
  
    /** initializes the action */
    protected CCSpeed(CCAction action, float r) {
        other = action;
        speed = r;
    }
