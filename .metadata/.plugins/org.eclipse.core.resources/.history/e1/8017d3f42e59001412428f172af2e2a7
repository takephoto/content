...
public class CCSprite extends CCNode implements CCRGBAProtocol, CCTextureProtocol {
    ...
    */
    ...
    //cc added 
    CCSpriteFrame orgFrame = null;
    
    
    public CCSpriteFrame getOrgFrame() {
		return orgFrame;
	}
...
//        texture_.checkName();
    ...
    */
	...
	//cc
	public static CCSprite spriteWithSpriteFrameName(String name){
		CCSpriteFrame frame = CCSpriteFrameCache.sharedSpriteFrameCache().getSpriteFrame(name);
		if(frame == null){
			return new CCSprite(name);
		}
