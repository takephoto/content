...
public final class Alarm implements Parcelable {
    ...
    public static class Columns implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                Uri.parse("content://com.xiaoshou.deskclock/alarm");
    ...
    // 对应的公共的每一列的映射
    public int        id;
    public boolean    enabled;//闹钟是否可用。
    public int        hour;
    public int        minutes;
    public DaysOfWeek daysOfWeek;
    public long       time;
    public boolean    vibrate;//闹钟是否震动
    public String     message;
    public Uri        alert;
    public boolean    silent;

    public Alarm(Cursor c,Context mContext) {
        ...
        String labs=c.getString(Columns.ALARM_MESSAGE_INDEX);
//        if(Constant_util.isEmpty(labs)){
//           if(null !=mContext)        	
////        	labs=mContext.getResources().getString(R.string.ordinary);
//        }
        message =  labs;
        String alertString = c.getString(Columns.ALARM_ALERT_INDEX);
//        if (Alarm.ALARM_ALERT_SILENT.equals(alertString)) {
//            silent = true;
//        } 
         {
...
//                		danci+"\t"+new SimpleDateFormat("yyyy/MM/dd").format(new Date()) : "";
            ...
            for (int i = 0; i < 7; i++) {
                if ((mDays & (1 << i)) != 0) {
                	String daysOfWeekStr=dayList[DAY_MAP[i]];
                ///	String weekStr=Constant_util.indexWeek(daysOfWeekStr);
                  //  ret.append(weekStr);
                    dayCount -= 1;
