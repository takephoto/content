	...
	public void onCreate(Bundle savedInstanceState) {
		...
		save.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent t = getIntent() ;
				t.putExtra("seltime", mSelTime) ;
				Map<String,String> map = alarmSets.get(0) ;
				t.putExtra("repdays", map.get("detail")) ;
				AlarmSet.this.setResult(1, t) ;
	...
	public void initTimeSelView(){
       ...
       OnWheelChangedListener wheelListener = new OnWheelChangedListener() {
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				mSelTime = hours.getCurrentItem() + ":"
						+ mins.getCurrentItem() + hour24.getCurrentItem();
				;
	...
	public void initData(){
		for(int i = 0; i < 3; i++){
			...
			if( i == 0){
				...
				map.put("detail", sh.getString("title", "") ) ;
            ...
            switch (requestCode) {
                case 0:
                  ...
                  /* SharedPreferences.Editor edit = sh.edit() ;
                   ...
                   edit.commit();*/
                   handle.sendEmptyMessage(UPDATELIST) ;
                   Log.d("update", "wwwwwwwwwwwww") ;
                   break;
                  case 1:
                	  
                	  String repeatDay = data.getStringExtra("reapDay") ;
                	  Map<String,String> reMap = alarmSets.get(0) ;
                      reMap.put("detail", repeatDay) ;
                      handle.sendEmptyMessage(UPDATELIST) ;
                	break ;
                default:
                   ;
