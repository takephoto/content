...
public class TestActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		scene.addChild(IntroLayer.node()) ;
	...
	static class BackLayer extends CCLayer{
		public BackLayer(){
			CCSprite backSprite = CCSprite.sprite("Image_376_at_frame_10.jpg") ;
			addChild(backSprite) ;
			backSprite.setPosition(CGPoint.ccp(0, 0)) ;
			backSprite.setAnchorPoint(CGPoint.ccp(0, 0)) ;
			
			CCSprite heroUp = CCSprite.sprite("Image544.png") ;
			backSprite.addChild(heroUp) ;
			
			heroUp.setPosition(CGPoint.ccp(100, 100)) ;
			CCSprite heroDown = CCSprite.sprite("Image523.png") ;
			heroDown.setPosition(CGPoint.ccp(110, 70)) ;
			backSprite.addChild(heroDown) ;
	...
	static class PauseTest extends ActionManagerDemo{
		...
		public void onEnter() {
			...
			CCSprite s = CCSprite.sprite("grossini.png") ;
			s.setPosition(CGPoint.ccp(200, 200)) ;
			addChild(s, 0, kTagGrossini) ;
			CCAction action = CCMoveBy.action(1.5f, CGPoint.ccp(150, 0)) ;
			CCActionManager.sharedManager().addAction(action, this, true) ;
			this.schedule("unpause",3) ;
		}
		
		public void unpause(float dt){
			unschedule("unpause") ;
			CCNode node = this.getChildByTag(kTagGrossini) ;
